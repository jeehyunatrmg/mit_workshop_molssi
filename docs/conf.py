...
project = 'molecool'
copyright = ("2021, Jeehyun Yang. Project structure based on the "
...
texinfo_documents = [
    (master_doc, 'molecool', 'molecool Documentation',
     author, 'molecool', 'A python package for analyzing and visualizing molecular files for Molssi Workshop',
     'Miscellaneous'),
]
